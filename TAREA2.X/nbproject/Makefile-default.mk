...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/TAREA2.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/TAREA2.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/PRINCIPAL.o: PRINCIPAL.S  .generated_files/af9f52c8cb7fcaec5f5cd893eb760cd50419e682.flag .generated_files/d0d60687cf94a6c1e5db1b3ca9d9cc4197f595d5.flag
	@${MKDIR} "${OBJECTDIR}" 
...
${OBJECTDIR}/PRINCIPAL.o: PRINCIPAL.S  .generated_files/63b21e5798227b4e3558c1f1c168b0f92335b984.flag .generated_files/d0d60687cf94a6c1e5db1b3ca9d9cc4197f595d5.flag
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/PRINCIPAL.o.d 
	@${RM} ${OBJECTDIR}/PRINCIPAL.o 
...
dist/${CND_CONF}/${IMAGE_TYPE}/TAREA2.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   p30F3013.gld
	...
	${MP_CC_DIR}\\xc16-bin2hex dist/${CND_CONF}/${IMAGE_TYPE}/TAREA2.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} -a  -omf=elf   -mdfp="${DFP_DIR}/xc16" 
